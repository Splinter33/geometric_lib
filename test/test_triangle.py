...
class functionTestTriangle(unittest.TestCase):
    def test_triangle_area(self):
        ...
        self.assertAlmostEqual(area(1, 1, 1), 
                               0.4330127018922193, places=7)
    
    def test_triangle_area1(self):
        # Проверяем, что треугольник с невалидными сторонами 
        #вызывает исключение
        with self.assertRaises(ValueError):
            area(1, 2, 3)

    def test_triangle_area2(self):
        # Проверяем площадь прямоугольного треугольника 
        self.assertAlmostEqual(area(3, 4, 5), 6.0, places=7)

    def test_triangle_area3(self):
        # Проверяем, что при наличии нулевой стороны
    ...
    def test_triangle_area5(self):
        ...
        self.assertAlmostEqual(area(234, 532, 423), 
                               47929.25018647277, places=7)

    def test_triangle_area6(self):
        # Проверяем, что слишком длинная сторона вызывает 
        # исключение
        with self.assertRaises(ValueError):
            area(9, 99, 999)
    
    def test_triangle_area7(self):
        # Проверяем, что отрицательная сторона вызывает 
        # исключение
        with self.assertRaises(ValueError):
            area(-21, 32, 99)

    def test_triangle_area8(self):
        # Проверяем, что отрицательные стороны вызывают 
        # исключение
        with self.assertRaises(ValueError):
            area(-25, -24, 69)
    ...
    def test_triangle_area9(self):
        ...
        #большими сторонами
        self.assertAlmostEqual(area(10000, 10000, 10000),
                               43301270.18922193, places=7)
